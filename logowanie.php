...
?>
  ...
  W celu zalogowania się proszę podaj nazwę konta użytkownika i hasło. Jeśli nie dysponujemy kontem, można je za darmo uzyskać. Wystarczy kliknąć odnośnik <a href="rejestrowanie.php">rejestrowanie</a>
  <p>
  <?php
    if(isset($_GET) && isset($_GET['error'])){
      echo "<strong>Niepoprawna nazwa u�ytkownika / has�o</strong>";
    }
  ?>
