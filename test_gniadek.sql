...
--
-- Host: localhost
-- Czas wygenerowania: 02 Cze 2012, 20:57
...
CREATE TABLE IF NOT EXISTS `zamowienia` (
  ...
  `id_adresu_przesylki` int(11) DEFAULT NULL,
  `metoda_platnosci` int(11) DEFAULT NULL,
...
(1, 1, 1, NULL, NULL, '2012-06-02 20:17:37', 0, NULL, NULL),
(2, 1, 1, NULL, NULL, '2012-06-02 20:17:44', 0, NULL, 11.96);
