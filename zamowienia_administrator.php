<?php
  ...
  else
  {
    ...
    else
    {
      ...
      {
        echo "<td>[<a href='szczegoly_zamowienia_administrator.php?id=" . $row['id'] . "'>Wyświetl</a>]</td>";
        ...
        echo "<td><a href='zamowienia_administrator.php?func=conf&id=" . $row['id'] . "'>Potwierdź płatność</a></td>";
      echo "</tr>";
      }
      echo "</table>";
    }
